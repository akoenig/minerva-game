...
public class PlayerHandler implements Handler {
	...
	public ValueObject read(int id) throws PersistenceException {
		System.out.println("PlayerHandler.read() - Filebased storage is not implemented.");
		return null;
	}
	...
	public Vector<? extends ValueObject> readAll()
		...
		System.out.println("PlayerHandler.readAll() - Filebased storage is not implemented.");
		return null;
	}
	...
	public void remove(ValueObject candidate) throws PersistenceException {
		System.out.println("PlayerHandler.remove() - Filebased storage is not implemented.");		
	}

	@Override
	public void save(ValueObject registrable) throws PersistenceException {
		System.out.println("PlayerHandler.save() - Filebased storage is not implemented.");
	}
